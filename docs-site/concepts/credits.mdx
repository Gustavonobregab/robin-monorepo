...
- Credits are **reserved when the job is created** (or, for synchronous text, before processing). If your balance can't cover the cost, the request is rejected before any work happens.
